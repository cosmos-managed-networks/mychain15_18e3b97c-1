...
HTTPS_GIT := github.com/mygithub/mychain15.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain15 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain15 --local -f chains.yaml
endif
